<?php/*<html> <body>
 ...
 <!-- ******************************************* -->
 <img width = "100" height = "100" onmouseout="HideTip()" onmouseover="ShowTip('���� ����������� ����� �����<br> ��� ���� ��� ��� ����������, ���<br> ��� ���� ������ ����� ������<br> �����. �� ����� ��� ��� ������<br> content = msg; � ����� �������')" />
 </body></html>*/
...
<div id="Layer2<?=($openedwindows); ?>" style="position:absolute; width:<?=$width?>px; height:21px; z-index:<?=(1+$openedwindows*2); ?>; left: <?=(61+$openedwindows*10); ?>px; top:<?echo ($changesize+68+$openedwindows*10);?>px; " class=<?=$class; ?>
	<?php  echo ">".$mainheader;$leftactwin=$width-(506-419); ?>
...
<div id="smsg<?=($openedwindows); ?>" style="position:absolute; width:<?=$width?>px; height:195px; z-index:<?=(1+$openedwindows*2);?>; left: <?=(61+$openedwindows*10); ?>px; top:<?echo ($changesize+90+$openedwindows*10);?>px;" class=<?=$bgcolor ;?>><?php 