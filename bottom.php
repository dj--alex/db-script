	<br>
		...
		<div id="bottom">
			<ul class="second-navigation">
				...
				<li><a href="mailto:dj--alexya.ru" id="sn_signup"><?if ($codekey>6) lprint ("REGI_DBS");?></a></li>
			</ul>
			<div class="txt">
		<?php 
		...
		?>
			...
			<div class="contact">
				<h6><?=cmsg ("CONINF")?></h6>
				<ul>
					<li><?=cmsg ("MAINDEV")?>: <a href="mailto:dj--alexya.ru?subject=DBscript">dj--alex</a></li>
					
					<li><?=cmsg ("DESIGN")?>: <a href="mailto:DeusModusmail.ru?subject=DBscriptDESIGN">DeusModus</a></li>
                    	<li><?=cmsg ("ICQSUPPORT")?>: <a href="icq:492-386-106">Shkent</a></li>
				</ul>
			</div>
		</div>
		<?php /*<!-- конец нижней части -->
		<!-- совсем низ =) -->*/?>
		<div id="footer">
			<!-- имеет смысл потом в этот совсем-низ вынести ссылки-->
	  </div>
		<?php /*<!-- конец совсем низа-->
...
for ($a=0;$a<$pgcnt;$a++) {
 ...
 if ($sd[19]=="utf-8") $printmenuoption=iconvx("windows-1251","utf-8",$printmenuoption);
