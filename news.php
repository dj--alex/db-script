...
if (!$activation) exit;
/*
 * ��� �� ����?   news.php  nedit.php - ���� ��� Dbscript
 * ������������� ������� ����� ����������� ��� ������ ��� �������, ID ���� ������� �� ������� _�����_ ��������� � �������
 * ����� ����� ���� ����� �������� � �������� (dbscriptbk._dbs__news43)
 * �������������� ����� �������� �� ��������� 15 ���� �� ���������
 * ������� ��� �� ��������� �������� � ����� ���� �������
 * �������� ������ � ����� �� ����� , �� �������, � ��������� ������������. (����� �������� flv)
 * �����: � ������ ������� �������������� HTML ����
...
$dateinunixminux15=$dateinunix-(1295684*2);  //CFG OPT FUTURE - ��� ����� ���� 15  ��� ����� ��������.
$dateminus15=date("d.m.Y H:i:s",$dateinunixminux15);
if ($debug) echo "date -15days= ".$dateminus15." ($dateinunixminux15)<br>";  //1295684 - 15 ����� ����.
$vID=$datesrch;
//$tempdate=date("d.m.Y H:i:s",1272436417);  //��������� ����� ���� � ���
