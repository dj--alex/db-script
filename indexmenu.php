...
?><div id="logo1" style="width:91px; height:55px; position:absolute; left:1px; top:1px; z-index:1;">
 ...
 <?php 
 if (!$pr[10]) { ?><a href="index.php?go=relogin" target="_top" ><img src="_style/<?php echo $sd[0]; ?>" alt="" name="" border="0"></a><font face="Arial"></font></font>      </address>
 <?php } ?> 
  </div>
</div>
<?php  
...
if (!$pr[45]) { echo "<img src=\"_style/".$grafictemp."$b.png\" "; } // ����� �������
 }
 ...
 if ($pr[45]) echo ">$printmenuoption</a></p></td></tr>";  // ���������� ������� ������ ��������� �������� �� ���� ���������
...
?>    <br><br><table border="0" cellpadding="0" cellspacing="0">
 ...
 ?> <form action="str0.php?p=<?=$pgcontent[$a+1][0];?>"><?php  $name=$pgcontent[$a+1][3];
...
?></table>
  <?php } ?>
      <br><br><br></table>
<?if (!$pr[10]) {
    ?> <h6 align="center">(c) 06-10 Dj--alex</h6><?php } ?>
</div>
<?php }


if (!$str0active) { ?></div>
<div id="module1" style="left:<?=$pr[44]; ?>px;top: 0px; background-color:<?=$rgbfon ; ?>; position:absolute; z-index:0; "> <?php }
//if ($str0active) { echo "</body></html>";};  // str0 ��� ��������� ������ �������� ���� �� ����, ���� ��� ��� ��� ������� dbscore
